	...
	function (msg, model) {
		...
		switch (_p0.ctor) {
			...
			case 'ExecuteAnimation':
				var _p3 = _p0._0;
				var executeAnimation = function (dict) {
					var _p1 = A2(_elm_lang$core$Dict$get, _p3, model.animationMappings);
					if (_p1.ctor === 'Just') {
						return A3(
							_elm_lang$core$Dict$insert,
							_p3,
				...
				var _p2 = A2(
					_elm_lang$core$Debug$log,
					A2(_elm_lang$core$Basics_ops['++'], 'ExecuteAnimation ', _p3),
					{ctor: '_Tuple0'});
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							animations: executeAnimation(model.animations)
						}),
			...
			default:
					...
					function (k, v) {
						return function (_p4) {
							...
							return {
								ctor: '_Tuple2',
								_0: _p5._1,
								_1: {ctor: '_Tuple2', _0: k, _1: _p5._0}
							};
						}(
							A2(_mdgriffith$elm_style_animation$Animation_Messenger$update, _p0._0, v));
					});
				var _p6 = _elm_lang$core$List$unzip(
					A2(
						...
						_elm_lang$core$Dict$toList(model.animations)));
				var cmds = _p6._0;
				var anims = _p6._1;
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							animations: _elm_lang$core$Dict$fromList(anims)
						}),
					_1: _elm_lang$core$Platform_Cmd$batch(cmds)
				};
		}
	});
var _user$project$Main$animationOrDefault = F2(
	function (manim, def) {
		var _p9 = manim;
		if (_p9.ctor === 'Nothing') {
			return def;
...
var _user$project$Main$fadeIn = function (manim) {
	return A2(
		...
		A2(
			_user$project$Main$animationOrDefault,
			manim,
...
var _user$project$Main$fadeOutFadeIn = function (manim) {
	return A2(
		_mdgriffith$elm_style_animation$Animation$interrupt,
		{
			ctor: '::',
			_0: _mdgriffith$elm_style_animation$Animation$toWithEach(
				{
					ctor: '::',
					_0: {
						ctor: '_Tuple2',
						_0: _mdgriffith$elm_style_animation$Animation$easing(
							{duration: 500, ease: _elm_community$easing_functions$Ease$linear}),
						_1: _mdgriffith$elm_style_animation$Animation$opacity(0)
					},
					_1: {ctor: '[]'}
				}),
			_1: {
				...
				_0: _mdgriffith$elm_style_animation$Animation$toWithEach(
					{
						...
						_0: {
							ctor: '_Tuple2',
							_0: _mdgriffith$elm_style_animation$Animation$easing(
								{duration: 300, ease: _elm_community$easing_functions$Ease$outExpo}),
							_1: _mdgriffith$elm_style_animation$Animation$opacity(1)
						},
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
...
var _user$project$Main$animationMappings = _elm_lang$core$Dict$fromList(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'fade_in', _1: _user$project$Main$fadeIn},
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'fade_out_fade_in', _1: _user$project$Main$fadeOutFadeIn},
			_1: {ctor: '[]'}
		}
	});
var _user$project$Main$Model = F2(
	function (a, b) {
		return {animations: a, animationMappings: b};
	});
var _user$project$Main$initializeModel = A2(_user$project$Main$Model, _elm_lang$core$Dict$empty, _user$project$Main$animationMappings);
var _user$project$Main$UpdateAnimation = function (a) {
	return {ctor: 'UpdateAnimation', _0: a};
};
var _user$project$Main$subscriptions = function (model) {
	return A2(
		_mdgriffith$elm_style_animation$Animation$subscription,
		_user$project$Main$UpdateAnimation,
		_elm_lang$core$Dict$values(model.animations));
};
var _user$project$Main$ExecuteAnimation = function (a) {
	return {ctor: 'ExecuteAnimation', _0: a};
};
var _user$project$Main$appView = function (model) {
	return A2(
		...
		A2(
					...
					_elm_lang$core$Dict$values(model.animations))),
			{
				...
				_0: _elm_lang$html$Html_Events$onClick(
					_user$project$Main$ExecuteAnimation('fade_out_fade_in')),
				_1: {
					ctor: '::',
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html$text('Click to Animate!'),
			_1: {ctor: '[]'}
		});
};
var _user$project$Main$view = _user$project$Main$appView;
var _user$project$Main$initializeApp = {
	ctor: '_Tuple2',
	_0: _user$project$Main$initializeModel,
	_1: A2(
		_elm_lang$core$Task$perform,
		function (identifier) {
			return _user$project$Main$ExecuteAnimation(identifier);
		},
		_elm_lang$core$Task$succeed('fade_in'))
};
var _user$project$Main$main = _elm_lang$html$Html$program(
	{init: _user$project$Main$initializeApp, subscriptions: _user$project$Main$subscriptions, update: _user$project$Main$update, view: _user$project$Main$view})();
var _user$project$Main$Initialize = {ctor: 'Initialize'};
